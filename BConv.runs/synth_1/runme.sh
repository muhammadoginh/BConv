...
HD_PWD='/home/moginh/Projects/BConv/BConv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BConvEngine_8PE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BConvEngine_8PE.tcl
