...
HD_PWD='D:/Projects/BConv/BConv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BConvEngine_8PE_V2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BConvEngine_8PE_V2.tcl
