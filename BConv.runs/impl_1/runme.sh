...
HD_PWD='D:/Projects/BConv/BConv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BConvEngine_8PE_V2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BConvEngine_8PE_V2.tcl -notrace
